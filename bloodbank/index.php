...
<div class="background_class">
	...
	<div class="donate_blood_bg">
		<h1 class="donate_blood" align="center">Donate blood, save life!<br><br></h1>
	</div>
	...
	<div class="center_class">
		...
		<div class="left_pan">    <!-- Left side area -->
			<h3 class="heading_class">Notifications</h3>
			<ul>
				<li></li>
				<li></li>
				<li></li>
		...
		<div class="center_class" align="center"> 
			...
			<?php 
				...
				<?php
					...
					?></h3><br>
					<span align="center"><a href="account.php" class="btn btn-primary">My account</a></span>
					<span align="center"><a href="signout.php" class="btn btn-primary">Signout</a></span>
					<?php
				}
				else
				{
					...
					<h3>Who are you?</h3>
					<form>
					<a href="blood_donors.php"><input type="button" value="I need blood!" name="choice1" class="btn btn-danger"></a>
					<a href="signup.php"><input type="button" value="I can donate blood!" name="choice2" class="btn btn-danger"></a>
					</form>
					<?php
				}
			?>
